...
function UpdateBlog() {
  ...
  const updateHandler = async () => {
    ...
    // base64
    let data;
    if (photo.includes("http")) {// means 'photo' still has 'http' sustring, means'user' hasn't changed photo, 
      data = {
        author,
        title,
        content,
  ...
  useEffect(() => {
    ...
    getBlogDetails();
  }, []); //passing "empty array" as Dependency Array, means 'useEffect' only runs when PAGE is MOUNTED 
